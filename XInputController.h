...
#define N64_ANALOG_MAX 127 //default val 127
#define XC_ANALOG_MAX 32767 //default val 32767
#define BUTTON_ANALOG_VALUE 49 //default value 107 modif for stick range to analog buttons (split 8 directions)
